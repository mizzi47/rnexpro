                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-9 col-lg-8 mx-auto">
                                ...
                                <!-- Sign In Form -->
                                <form action="<?php echo base_url('welcome/sendpass'); ?>" method="post">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Enter Email<font color="red">&ensp;*</font></label>
                                                <input type="email" name="email" id="email" class="form-control" >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="d-grid">
                                        <button class="btn btn-lg btn-primary btn-login text-uppercase fw-bold mb-2" type="submit" onclick="return confirm('Are you sure the email is registered?')" name="submit">Submit</button>
                                    </div>
