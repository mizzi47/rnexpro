...
<head>
    ...
    <style>
        ...
        .bg-image {
            background-image: url('<?= base_url() ?>assets/img/rnexpro.png');
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-9 col-lg-8 mx-auto">
                                <img src="<?= base_url() ?>assets/img/RexinProSoft_logo.jpeg" style="width:140px;">
                                ...
                                <form action="<?php echo base_url('welcome/register_user'); ?>" method="post">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Email :<font color="red">&ensp;*</font></label>
                                                <input type="email" name="email"  class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Phone Number :<font color="red">&ensp;*</font></label>
                                                <input type="text" name="phone"  class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Company Name :<font color="red">&ensp;*</font></label>
                                                <input type="text" name="company_name"  class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Company Register Number :<font color="red">&ensp;*</font></label>
