                              ...
                              <div class="card card-primary card-outline card-outline-tabs">
                                  <div class="card-header p-0 border-bottom-0">
                                      <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                                          <li class="nav-item">
                                              <a class="nav-link active" id="custom-tabs-job-tab" data-toggle="pill" href="#custom-tabs-job" role="tab" aria-controls="custom-tabs-job" aria-selected="true">Job</a>
                                          </li>
                                          <li class="nav-item">
                                  ...
                                  <div class="card-body">
                                      <div class="tab-content" id="custom-tabs-four-tabContent">
                                          <div class="tab-pane fade show active" id="custom-tabs-job" role="tabpanel" aria-labelledby="custom-tabs-job-tab">
                                              <?php $this->load->view('jobs/view/create_job') ?>
                                          </div>
                                          <div class="tab-pane fade" id="custom-tabs-owner" role="tabpanel" aria-labelledby="custom-tabs-owner-tab">
                                              <?php $this->load->view('jobs/view/create_owner') ?>
                                          </div>
