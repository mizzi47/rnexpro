                              ...
                              <div class="card card-primary card-outline card-outline-tabs">
                                  <div class="card-header p-0 border-bottom-0">
                                      <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                                          ...
                                          <li class="nav-item">
                                              <a class="nav-link active" id="custom-tabs-owner-tab" data-toggle="tab" href="#custom-tabs-owner" role="tab" aria-controls="custom-tabs-owner" aria-selected="false">Client</a>
                                          </li>
                                          <li class="nav-item">
                                  ...
                                  <div class="card-body">
                                      <div class="tab-content" id="custom-tabs-four-tabContent">
                                          ...
                                          <div class="tab-pane fade show active" id="custom-tabs-owner" role="tabpanel" aria-labelledby="custom-tabs-owner-tab">
                                              <?php $this->load->view('jobs/view/create_owner.php') ?>
                                          </div>
                                          <div class="tab-pane fade" id="custom-tabs-internal" role="tabpanel" aria-labelledby="custom-tabs-internal-tab">
                                              <?php $this->load->view('jobs/view/create_internal') ?>
                                          </div>
                                          <!-- <div class="tab-pane fade" id="custom-tabs-vendors" role="tabpanel" aria-labelledby="custom-tabs-vendors-tab">
