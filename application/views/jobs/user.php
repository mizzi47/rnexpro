                              ...
                              <div class="card card-primary card-outline card-outline-tabs">
                                  <div class="card-header p-0 border-bottom-0">
                                      <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                                          ...
                                          <li class="nav-item">
                                              <a class="nav-link active" id="custom-tabs-internal-tab" data-toggle="tab" href="#custom-tabs-internal" role="tab" aria-controls="custom-tabs-internal" aria-selected="false">Internal Users</a>
                                          </li>
                                          <!-- <li class="nav-item">
                                  ...
                                  <div class="card-body">
                                      <div class="tab-content" id="custom-tabs-four-tabContent">
                                          ...
                                          <div class="tab-pane fade show active" id="custom-tabs-internal" role="tabpanel" aria-labelledby="custom-tabs-internal-tab">
